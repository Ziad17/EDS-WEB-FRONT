...
if ($_SERVER['REQUEST_METHOD']== 'POST') {
  ...
  $acd_number =filter_var($_POST['acd_number'],FILTER_SANITIZE_NUMBER_INT);
...
////////////////////////////////////////////////////////////////////
      if (!empty($acd_number)) {
        if (strlen($acd_number) < 11)
         {
          $FormErrors[]='Academic Number Must Be <strong> 11 </strong> Number';
         }
      }else
      {
        $FormErrors[]='Academic Number Is <strong> Empty </strong>';
      }
  ...
  <div class="container">
    <form  class="main contact-form card card-outline card-primary" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
      ...
      <div class="form-group">
        ...
        value="<?php if (isset($acd_number)){echo $acd_number;  };?>" required />
