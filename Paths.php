...
define('EXCEPTIONS_BASE_PATH', PUBLIC_BASE_PATH.'/Modules/Exceptions');
define('FILE_MANAGEMENT_BASE_PATH', PUBLIC_BASE_PATH.'/Modules/FileManagement');
define('NOTIFICATIONS_BASE_PATH', PUBLIC_BASE_PATH.'/Modules/Notifications');
define('PERMISSIONS_BASE_PATH', PUBLIC_BASE_PATH.'/Modules/Permissions');
define('SEARCH_BASE_PATH', PUBLIC_BASE_PATH.'/Modules/Search');
...
define('CSS_BASE_PATH', PUBLIC_BASE_PATH.'/css');
define('IMG_BASE_PATH', PUBLIC_BASE_PATH.'/img');
define('JS_BASE_PATH', PUBLIC_BASE_PATH.'/js');
